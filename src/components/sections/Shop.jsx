...
const Product = () => {
  const { addToCart } = useCart(); // 🔥 INI PENTING
  ...
  const handleAddToCart = (item) => {
    addToCart(item); // 🔥 MASUK KE CART CONTEXT
  };

  return (
    <section id="product" className="py-20 bg-zinc-950 text-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-stone-400 mt-2">
            Coffee tools, beans & lifestyle products
          </p>
        </div>
            ...
            >
              ...
              <div className="p-5">
                ...
                <button
                  ...
                  className="mt-4 w-full bg-amber-700 hover:bg-amber-600 transition text-white py-2 rounded-lg font-medium"
                >
                  Add to Cart
                </button>
              </div>
